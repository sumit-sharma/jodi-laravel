            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mt-4">
                        ...
                        <input name="meeting_date" class="form-control" type="date" value="2019-08-19" id="">
                    </div>
                    <div class="col-4 mt-4">
                        <label for="" class="form-label">Meeting Time:</label>
                        <input name="meeting_time" class="form-control timepicker" type="text" id="meeting_time">
                    </div>
                    <div class="col-4 mt-4">
                        <label for="" class="form-label">Meeting Place:</label>
                        <input name="meeting_place" class="form-control" type="text" value="" id="">
                    </div>
                    <div class="clearfix"></div>
