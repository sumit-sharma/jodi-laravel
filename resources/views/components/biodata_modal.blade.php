    ...
    <script>
        ...
        $(document).on("click", ".biodata_modal", function () {
            ...
            Promise.all([
                ...
                fetch(`{{ route('fetch-contact-details', ['rno' => ':rno']) }}`.replace(':rno', rno))
                    .then(r => r.json())
                ...
                $("#Modal_biodata #contactphone").text(contactData.data.contactphone);


                $("#Modal_biodata #contactemail").text(contactData.data.contactemail);
