                ...
                <form id="frmAddInteraction" method="{{ route('save-interaction') }}"  method="POST">
                 ...
                 <div class="row">
                     ...
                     <div class="col-6 mt-0">
                         ...
                         <input class="form-control" type="date" id="inter_dated" name="dated" placeholder="" max="{{ now()->format('Y-m-d') }}" value="{{ now()->format('Y-m-d') }}" required>
                        </div>
                        <div class="col-6 mt-0">
                         <label for="" class="form-label">Intraction Time:</label>
                            <input class="form-control" type="text" id="inter_tob" name="time" placeholder="Interaction Time" readonly>
                    </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-4 mt-4">
                         ...
                         <input name="futuredate" class="form-control" type="date" min="{{ now()->format('Y-m-d') }}" required>
                     </div>
                     <div class="clearfix"></div>
                     ...
                     <div class="col-12 mt-4">
                         <button type="button" id="btnAddInteraction" class="btn btn-primary waves-effect waves-light">Save
                             Interaction</button>
                     </div>
                     <div class="clearfix"></div>
