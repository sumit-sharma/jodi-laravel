						...
						<div class="row">
							<div class="col-md-12">
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									<h4 class="mb-sm-0 font-size-18">Add References</h4>
									<div class="page-title-right">
										<ol class="breadcrumb m-0">
											<li class="breadcrumb-item"><a href="javascript: void(0);">References</a></li>
											<li class="breadcrumb-item active">Add References</li>
										</ol>
									</div>
								</div>
							</div>
								...
								<form action="#" id="frmAddEditReferences" method="POST">
									...
									<div class="row">
										...
										<div class="col-6 mt-3">
											<div class="mb-3">
												...
												<textarea id="address" name="address" class="form-control" rows="4"
													spellcheck="false" maxlength="250"></textarea>
											</div>
										</div>
										<div class="clearfix"></div>
										...
										<div class="col-md-6 mt-3">
											...
											<input class="form-control" type="text" name="city" id="city" maxlength="100">
										</div>
										<div class="col-md-6 mt-3">
											<label for="status" class="form-label"> Status </label>
											<input class="form-control" type="text" name="status" maxlength="100">
										</div>
										<div class="col-md-6 mt-3">
											<label for="assignedto" class="form-label"> Assign To</label>
											<select class="form-select select2-notag" name="assignedto" id="assignedto">
