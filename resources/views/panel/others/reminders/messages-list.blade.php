                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Messages List</h4>
                                ...
                                <table id="tech-companies-1" class="table table-bordered">
                                    <thead class="table-primary pdng_d">
                                        <tr>
                                            ...
                                            <th data-priority="2" width="">Matter</th>
                                            <th data-priority="3" width="">Date</th>
                                            <th data-priority="4" width="">Time</th>
                                            <th data-priority="5" width="">MsgFrom</th>
                                            <th data-priority="6" width="">MsgTo</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody class="pdng_d">
                                        @foreach ($messages as $message)
                                            <tr>
                                                ...
                                                <td>{{ convertCommonDate($message->dated) }}</td>
                                                <td>{{ convertCommonDate($message->time, 'h:i A') }}</td>
