                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">No Touch Report</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                                            <li class="breadcrumb-item active">No Touch Report</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <select class="form-select" name="dtype">
                                ...
                                <option value="H" {{ request()->get('dtype') == 'H' ? 'selected' : '' }}>Paid Member (Non
                                    Hold)</option>
                                <option value="N" {{ request()->get('dtype') == 'N' ? 'selected' : '' }}>Non Paid Member
                                </option>
                                <option value="both" {{ request()->get('dtype') == 'both' ? 'selected' : '' }}>Both Paid & Non
                                    Paid</option>
                            </select>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="col-12 mb-3">
                            <label class="form-label">No Touch Period:</label>
                            <select class="form-select" name="ntp">
                                <option value="">Select</option>
                                <option value="7" {{ request()->get('ntp') == '7' ? 'selected' : '' }}>No Touch in last 7 Days
                                </option>
                                <option value="15" {{ request()->get('ntp') == '15' ? 'selected' : '' }}>No Touch in last 15
                                    Days</option>
                                <option value="30" {{ request()->get('ntp') == '30' ? 'selected' : '' }}>No Touch in last 1
                                    Month</option>
                                <option value="90" {{ request()->get('ntp') == '90' ? 'selected' : '' }}>No Touch in last 3
                                    Months</option>
                                <option value="180" {{ request()->get('ntp') == '180' ? 'selected' : '' }}>No Touch in last 6
                                    Months</option>
                                <option value="365" {{ request()->get('ntp') == '365' ? 'selected' : '' }}>No Touch in last 1
                                    Year</option>
                            </select>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <label for="to_date" class="form-label"> No Touch Status</label>
                            <select class="form-select" name="nts">
                                <option value="">Select</option>
                                <option value="2" {{ request()->get('nts') == '2' ? 'selected' : '' }}>Both</option>
                                <option value="0" {{ request()->get('nts') == '0' ? 'selected' : '' }}>No Interaction</option>
                                <option value="1" {{ request()->get('nts') == '1' ? 'selected' : '' }}>No Mail</option>
                            </select>
                        </div>
