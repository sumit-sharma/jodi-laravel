                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">My Future Calls</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                                            <li class="breadcrumb-item active">My Future Calls</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table id="tech-companies-1" class="table table-bordered">
                                            <thead class="table-primary pdng_d">
                                                <tr>
                                                    ...
                                                    <th data-priority="4" width="">Dated</th>
                                                    <th data-priority="5" width="">Time</th>
                                                    <th data-priority="6" width="">Description</th>
                                                    <th data-priority="7" width="">Future Date</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody class="pdng_d">
                                                @forelse ($TableData as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ convertCommonDate($item->futuredate) }}</td>
                                                    </tr>
                                                @empty
                                                    <tr>
