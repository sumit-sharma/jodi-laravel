                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-2">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ auth()->user()->username . '-' . auth()->user()->name }}" disabled>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="col-6 mt-2">
                                            <label for="callsource" class="form-label">Source of Calls</label>
                                            <input class="form-control" name="callsource" type="text" id="callsource"
                                                required>
                                        </div>
                                        <div class="col-6 mt-2">
                                            <label for="noofcalls" class="form-label"> No of Calls Done </label>
                                            <input class="form-control" name="noofcalls" type="text" id="noofcalls"
                                                required>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="col-6 mt-2">
                                            <label for="callsconnected" class="form-label">No of Calls Connected</label>
                                            <input class="form-control" name="callsconnected" type="text"
                                                id="callsconnected" required>
                                        </div>
                                        <div class="col-6 mt-2">
                                            <label for="followupcalls" class="form-label"> No of followupcalls </label>
                                            <input class="form-control" name="followupcalls" type="text" id="followupcalls"
                                                required>
                                        </div>
                                        <div class="clearfix"></div>
