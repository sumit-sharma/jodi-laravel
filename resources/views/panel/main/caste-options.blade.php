                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Caste Options</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Main</a></li>
                                        <li class="breadcrumb-item active">Caste Options</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <hr>
                        <form id="frmAddCaste" action="{{ route('panel.caste-options.store') }}" method="POST">
                            @csrf
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <label class="form-label">Caste List</label>
                                        <select id="caste-list" class="form-select select2-notag">
                                    ...
                                    <div class="col-6 mt-3">
                                        <div class="mb-3">
                                            <label for="caste" class="form-label">Add New Caste</label>
                                            <input type="text" class="form-control" id="caste" name="caste"
                                                placeholder="Enter Caste Name" required>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
