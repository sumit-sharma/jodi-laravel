                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div>
                                            ...
                                            <div class="col-md-2 col-6 mb-2">
                                                ...
                                                <select id="height_cm" name="hght" class="form-select">
                                                    ...
                                                    @foreach (range(122, 214) as $item)
                                                        <option value="{{ $item }}" {{ $item == '165' ? 'selected' : '' }}>
                                                            {{ $item }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col mb-2">
                                            ...
                                            {{-- <select id="caste" name="caste" class="form-select select2-newentry"> --}}
                                                <select id="caste" name="caste" class="form-select select2-notag">
                                        ...
                                        <div class="col mb-2">
                                            ...
                                            {{-- <input class="form-control" type="text" placeholder="Enter gotra name">
                                            --}}
                                        </div>
                                        <div class="col mb-2">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <input type="text" id="spects" name="spects" class="form-control" value="None">
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <textarea name="dd" id="dd" class="form-control" rows="4"
                                                placeholder="Enter disease/disability"></textarea>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            {{-- <textarea class="form-control" rows="4"
                                                placeholder="Enter characteristics"></textarea> --}}
                                        ...
                                        <div class="col-lg-11 col-11">
                                            <div class="row">
                                                <div class="col-lg-4 col-12">
                                                    ...
                                                    <input class="form-control" type="text" name="educourse[]" required
                                                        placeholder="Enter name of course">
                                                </div>
                                                <div class="col-lg-4 col-12 mb-2 pt-2">
                                                    <label for="" class="form-label">Institution:</label>
                                                    <input class="form-control" type="text" name="eduinst[]" required
                                                        placeholder="Enter Institution name">
                                                </div>
                                                <div class="col-lg-4 col-12">
                                                    <label for="" class="form-label">Year:</label>
                                                    <input class="form-control" type="text" name="eduyear[]" required
                                ...
                                <div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-lg-4 col-12 mb-2">
                                            ...
                                            {{-- <input class="form-control" type="text" placeholder="Enter residing city">
                                            --}}
                                ...
                                <div class="section_family">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-6 col-12 mb-2">
                                            ...
                                            <textarea name="personaldetails" id="personaldetails" class="form-control"
                                                rows="4" placeholder="Enter extra info"></textarea>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-4 col-12 mb-2">
                                            ...
                                            {{-- <input class="form-control" type="text" placeholder="Enter info"> --}}
                                            <select id="familynative" name="familynative"
                                                class="form-select select2-distinct" data-table="profile_personal"
                                                data-column="familynative">
                                        ...
                                        <div class="col-lg-4 col-12 mb-2">
                                            ...
                                            <input class="form-control" type="text" name="familyincomem" id="familyincomem">
                                        </div>
                                ...
                                <div class="section_person">
                                    <div class="row mb-2">
                                        <div class="col-lg-3 col-12 mb-2">
                                            ...
                                            <input class="form-control" name="contactperson" type="text" id="contactperson"
                                                placeholder="Enter contact person name">
                                        </div>
                                        <div class="col-lg-9 col-12 mb-2">
                                            <label for="" class="form-label">Address:</label>
                                            <textarea name="contactaddress" id="contactaddress" class="form-control"
                                                rows="1" placeholder="Enter complete address"></textarea>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
