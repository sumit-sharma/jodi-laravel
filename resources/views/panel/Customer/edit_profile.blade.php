                        ...
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input class="form-control" type="date" id="dob" name="dob"
                                            ...
                                            value="{{ $customer->bio->dob }}" required>
                                    </div>
                                    <div class="col-md-3 mb-2">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <select name="wtkg" class="form-select">
                                            ...
                                            <option value="{{ $item }}"
                                                {{ $item == $customer->bio->wtkg ? 'selected' : '' }}>
                                                {{ $item . ' kg' }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-2 row-cols-5"">
                                    ...
                                    <select id="religion" name="religion" class="form-select">
                                        <option value="1"
                                            {{ $customer->bio->religion->value == 1 ? 'selected' : '' }}>Hindu
                                        </option>
                                        <option value="2"
                                            {{ $customer->bio->religion->value == 2 ? 'selected' : '' }}>Sikh
                                        </option>
                                        <option value="3"
                                            {{ $customer->bio->religion->value == 3 ? 'selected' : '' }}>Jain
                                        </option>
                                        <option value="4"
                                            {{ $customer->bio->religion->value == 4 ? 'selected' : '' }}>Christian
                                        </option>
                                        <option value="5"
                                            {{ $customer->bio->religion->value == 5 ? 'selected' : '' }}>Muslim
                                        </option>
                                    </select>
                                </div>
                                <div class="col mb-2">
                                    ...
                                    <select id="caste" name="caste" class="form-select select2-newentry">
                                        ...
                                        <option value="{{ $caste->id }}"
                                            {{ $customer->bio->caste == $caste->id ? 'selected' : '' }}>
                                            {{ $caste->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col mb-2">
                                    ...
                                    <select name="complexion" class="form-select">
                                        <option value="1"
                                            {{ $customer->bio->complexion->value == 1 ? 'selected' : '' }}>Very Fair
                                        </option>
                                        <option value="2"
                                            {{ $customer->bio->complexion->value == 2 ? 'selected' : '' }}>Fair
                                        </option>
                                        <option value="3"
                                            {{ $customer->bio->complexion->value == 3 ? 'selected' : '' }}>Wheatish
                                        </option>
                                        <option value="4"
                                            {{ $customer->bio->complexion->value == 4 ? 'selected' : '' }}>Brown
                                        </option>
                                        <option value="5"
                                            {{ $customer->bio->complexion->value == 5 ? 'selected' : '' }}>Dark
                                        </option>
                                    </select>
                                </div>
                                <div class="clearfix"></div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 mb-2">
                                    ...
                                    <select name="eyecolor" id="eyecolor" class="form-select">
                                        <option value="1"
                                            {{ $customer->personal->eyecolor->value == 1 ? 'selected' : '' }}>Amber
                                        </option>
                                        <option value="2"
                                            {{ $customer->personal->eyecolor->value == 2 ? 'selected' : '' }}>Blue
                                        </option>
                                        <option value="3"
                                            {{ $customer->personal->eyecolor->value == 3 ? 'selected' : '' }}>Brown
                                        </option>
                                        <option value="4"
                                            {{ $customer->personal->eyecolor->value == 4 ? 'selected' : '' }}>Black
                                        </option>
                                        <option value="5"
                                            {{ $customer->personal->eyecolor->value == 5 ? 'selected' : '' }}>Gray
                                        </option>
                                        <option value="6"
                                            {{ $customer->personal->eyecolor->value == 6 ? 'selected' : '' }}>Green
                                        </option>
                                        <option value="7"
                                            {{ $customer->personal->eyecolor->value == 7 ? 'selected' : '' }}>Hazel
                                        </option>
                                        <option value="8"
                                            {{ $customer->personal->eyecolor->value == 8 ? 'selected' : '' }}>Red &
                                            Violet</option>
                                        <option value="9"
                                            {{ $customer->personal->eyecolor->value == 9 ? 'selected' : '' }}>
                                            Spectrum</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-2">
                                    ...
                                    <select name="haircolor" id="haircolor" class="form-select">
                                        <option value="1"
                                            {{ $customer->personal->haircolor->value == 1 ? 'selected' : '' }}>Black
                                        </option>
                                        <option value="2"
                                            {{ $customer->personal->haircolor->value == 2 ? 'selected' : '' }}>Brown
                                        </option>
                                        <option value="3"
                                            {{ $customer->personal->haircolor->value == 3 ? 'selected' : '' }}>Grey
                                        </option>
                                        <option value="4"
                                            {{ $customer->personal->haircolor->value == 4 ? 'selected' : '' }}>Blond
                                        </option>
                                        <option value="5"
                                            {{ $customer->personal->haircolor->value == 5 ? 'selected' : '' }}>Bald
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-2">
                                ...
                                <div class="col-md-3 mb-2">
                                    ...
                                    <select name="astrostatus" id="astrostatus" class="form-select">
                                        <option value="1"
                                            {{ $customer->bio->astrostatus->value == 1 ? 'selected' : '' }}>Manglik
                                        </option>
                                        <option value="2"
                                            {{ $customer->bio->astrostatus->value == 2 ? 'selected' : '' }}>Slightly
                                            Manglik</option>
                                        <option value="3"
                                            {{ $customer->bio->astrostatus->value == 3 ? 'selected' : '' }}>Non
                                            Manglik</option>
                                        <option value="4"
                                            {{ $customer->bio->astrostatus->value == 4 ? 'selected' : '' }}>Don't
                                            Believe</option>
                                        <option value="5"
                                            {{ $customer->bio->astrostatus->value == 5 ? 'selected' : '' }}>Don't
                                            Know</option>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 mb-2">
                                    ...
                                    <select name="drinkinghabit" id="drinkinghabit" class="form-select">
                                        <option value="1"
                                            {{ $customer->bio->drinkinghabit->value == 1 ? 'selected' : '' }}>Non
                                            Consumer</option>
                                        <option value="2"
                                            {{ $customer->bio->drinkinghabit->value == 2 ? 'selected' : '' }}>Drink
                                            Occasionally</option>
                                        <option value="3"
                                            {{ $customer->bio->drinkinghabit->value == 3 ? 'selected' : '' }}>Regular
                                            Drinker</option>
                                        <option value="4"
                                            {{ $customer->bio->drinkinghabit->value == 4 ? 'selected' : '' }}>Don't
                                            Know</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-2">
                                    ...
                                    <select name="smokinghabit" id="smokinghabit" class="form-select">
                                        <option value="1"
                                            {{ $customer->bio->smokinghabit->value == 1 ? 'selected' : '' }}>Non
                                            Smoker</option>
                                        <option value="2"
                                            {{ $customer->bio->smokinghabit->value == 2 ? 'selected' : '' }}>Smoker
                                        </option>
                                        <option value="3"
                                            {{ $customer->bio->smokinghabit->value == 3 ? 'selected' : '' }}>Don't
                                            Know</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-2">
                                    ...
                                    <select name="eatinghabit" id="eatinghabit" class="form-select">
                                        <option value="1"
                                            {{ $customer->bio->eatinghabit->value == 1 ? 'selected' : '' }}>
                                            Vegetarian</option>
                                        <option value="2"
                                            {{ $customer->bio->eatinghabit->value == 2 ? 'selected' : '' }}>
                                            Eggetarian</option>
                                        <option value="3"
                                            {{ $customer->bio->eatinghabit->value == 3 ? 'selected' : '' }}>Non
                                            Vegetarian</option>
                                        <option value="4"
                                            {{ $customer->bio->eatinghabit->value == 4 ? 'selected' : '' }}>Don't
                                            Know</option>
                                        <option value="5"
                                            {{ $customer->bio->eatinghabit->value == 5 ? 'selected' : '' }}>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <textarea name="dd" id="dd" class="form-control" rows="4" placeholder="Enter disease/disability">{{ $customer->bio->dd }}</textarea>
                                </div>
                                <div class="col-md-4 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-2">
                                    ...
                                    <select name="education" class="form-select">
                                        <option value="1"
                                            {{ $customer->bio->education->value == 1 ? 'selected' : '' }}>Matriculate
                                        </option>
                                        <option value="2"
                                            {{ $customer->bio->education->value == 2 ? 'selected' : '' }}>Under
                                            Graduate</option>
                                        <option value="3"
                                            {{ $customer->bio->education->value == 3 ? 'selected' : '' }}>Graduate
                                        </option>
                                        <option value="6"
                                            {{ $customer->bio->education->value == 6 ? 'selected' : '' }}>Double
                                            Graduate</option>
                                        <option value="4"
                                            {{ $customer->bio->education->value == 4 ? 'selected' : '' }}>Post
                                            Graduate</option>
                                        <option value="5"
                                            {{ $customer->bio->education->value == 5 ? 'selected' : '' }}>Doctorate
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="section_occupation">
                            <div class="row">
                                <div class="col-lg-2 col-12 mb-2">
                                    ...
                                    <select name="occupation" id="occupation" class="form-select">
                                        ...
                                        <option value="{{ $item->occ_code }}" {{ $customer->bio->occupation == $item->occ_code ? 'selected':'' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-2 col-12 mb-2">
                                ...
                                <div class="col-lg-2 col-12 mb-2">
                                    ...
                                    <input class="form-control" type="text" name="salary" value="{{ $customer->personal->salary }}"
                            ...
                            <div class="row bg-secondary-subtle mb-3 pt-3">
                                <div class="col-lg-4 col-12 mb-2">
                                    ...
                                    <input class="form-control" type="text" name="orgname[]" value="{{ $item->orgname }}"
                                        placeholder="Enter company name">
                                </div>
                                <div class="col-lg-3 col-12 mb-2">
                                    <label for="" class="form-label">Designation:</label>
                                    <input class="form-control" type="text" name="orgdept[]" value="{{ $item->orgdept }}"
                                        placeholder="Enter job designation">
                                </div>
                                <div class="col-lg-3 col-12 mb-2">
                                    <label for="" class="form-label">Working Year:</label>
                                    <input class="form-control" type="text" name="orgyear[]" value="{{ $item->orgyear }}"
                                ...
                                <div class="col-lg-2 mb-2">
                                    ...
                                    @if (!$loop->first)
                                    <button type="button" class="btn btn-danger waves-effect waves-light btnRemoveExperience">
                                        <span class="font-size-14">-</span>
                                    </button>
                                    @endif
                                </div>
                        ...
                        <div>
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <select name="rs" id="rs" class="form-select">
                                        <option value="1" {{ $customer->rs == 1 ? 'selected':'' }}>Indian Citizen</option>
                                        <option value="2" {{ $customer->rs == 2 ? 'selected':'' }}>Temp. Residing Abroad</option>
                                        <option value="3" {{ $customer->rs == 3 ? 'selected':'' }}>Non Resident Indian</option>
                                    </select>
                                </div>
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <select name="rcountry" id="rcountry" class="form-select select2-notag">
                                        ...
                                        <option value="{{ $item->country }}" {{ $item->country == $customer->personal->rcountry ? 'selected':'' }}>{{ $item->country }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-3 col-12 mb-2">
                                ...
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <select name="nationality" class="form-select  select2-notag">
                                        ...
                                        <option value="{{ $item->nationality }}" {{ $customer->personal->nationality == $item->nationality ?'selected':'' }}>{{ $item->nationality }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-4 col-12 mb-2">
                                    ...
                                    <select name="rcity" class="form-select select2-distinct"
                                        data-table="profile_personal" data-column="rcity" data-value="{{ $customer->personal->rcity }}">
                                    </select>
                                </div>
                                <div class="col-lg-4 col-12 mb-2">
                                    <label class="form-label">Marital:</label>
                                    <select name="ms" id="ms" class="form-select">
                                        <option value="1" {{ $customer->ms == 1 ? 'selected' : '' }}>Never Married</option>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-6 col-12 mb-2">
                                    ...
                                    <textarea name="marriageinfo" id="marriageinfo" class="form-control" rows="4" placeholder="Enter info">{{ $customer->personal->marriageinfo }}</textarea>
                                </div>
                                <div class="col-lg-6 col-12 mb-2">
                                    <label for="" class="form-label">Child Info:</label>
                                    <textarea name="childdetails" id="childdetails" class="form-control" rows="4" placeholder="Enter info">{{ $customer->personal->childdetails }}</textarea>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        ...
                        <div class="section_family">
                            ...
                            <div class="sibling-span row bg-secondary-subtle mb-3 pt-3 pb-3">
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <input name="bsname[]" class="form-control" type="text"
                                        placeholder="Enter name" value="{{ $item->bsname }}">
                                </div>
                                <div class="col-lg-2 col-12 mb-2">
                                    ...
                                    <select name="bs[]" class="form-select">
                                        ...
                                        <option {{ $item->bs == "Younger Brother"? 'selected':'' }}>Younger Sister</option>
                                        <option {{ $item->bs == "Younger Brother"? 'selected':'' }}>Elder Brother</option>
                                ...
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <input name="bsdetails[]" class="form-control" type="text" value="{{ $item->bsdetails }}"
                                ...
                                <div class="col-lg-1 col-12 mb-2">
                                    ...
                                    @if (!$loop->first)
                                    <button type="button" class="btn btn-danger waves-effect waves-light btnRemoveSiblingRow">
                                        <span class="font-size-14">-</span>
                                    </button>
                                    @endif
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <input class="form-control" type="text" name="fathersname" value="{{ $customer->personal->fathersname }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <input name="mothersname" class="form-control" type="text" value="{{ $customer->personal->mothersname }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-4 col-12 mb-2">
                                    ...
                                    <select name="familyincome" id="familyincome" class="form-select">
                                        @foreach ($incomes as $item)
                                        <option value="{{ $item->inc_code }}" {{ $item->inc_code == $customer->personal->familyincome ? 'selected':'' }}>{{ $item->income }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-4 col-12 mb-2">
                                    ...
                                    <select id="familynative" name="familynative"
                                        class="form-select select2-distinct" data-table="profile_personal"
                                        data-column="familynative" data-value="{{ $customer->personal->familynative }}">
                                    </select>

                                </div>
                                <div class="col-lg-4 col-12 mb-2">
                                    <label for="" class="form-label">F. Inc (M):</label>
                                    <input class="form-control" type="text" name="familyincomem" value="{{ $customer->personal->familyincomem }}"
                                        id="familyincomem">
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-12 col-12 mb-2">
                                    ...
                                    <input class="form-control" type="text" name="budget" value="{{ $customer->personal->budget }}"
                        ...
                        <div class="section_person">
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <input class="form-control" name="contactperson" type="text" value="{{ $customer->personal->contactperson }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <select id="arealocation" name="arealocation"
                                        class="form-select select2-distinct" data-table="profile_personal"
                                        data-column="arealocation" data-value="{{ $customer->personal->arealocation }}">
                                    </select>
                                ...
                                <div class="col-lg-2 col-12 mb-2">
                                    ...
                                    <select id="contactcity" name="contactcity"
                                        class="form-select  select2-distinct" data-table="profile_personal"
                                        data-column="contactcity" data-value="{{ $customer->personal->contactcity }}">
                                    </select>
                                ...
                                <div class="col-lg-2 col-12 mb-2">
                                    ...
                                    <input class="form-control" type="text" name="contactpincode" value="{{ $customer->personal->contactpincode }}"
                                ...
                                <div class="col-lg-2 col-12 mb-2">
                                    ...
                                    <select id="contactstate" name="contactstate"
                                        class="form-select select2-distinct" data-table="profile_personal"
                                        data-column="contactstate" data-value="{{ $customer->personal->contactstate }}">
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <select name="contactcountry" id="contactcountry"
                                        class="form-select select2-distinct" data-table="profile_personal"
                                        data-column="contactcountry" data-value="{{ $customer->personal->contactcountry }}">
                                        {{-- @foreach ($countries as $item)
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <input class="form-control" type="text" name="contactphone" value="{{ $customer->personal->contactphone }}"
                                        id="contactphone" placeholder="Enter number">
                                </div>
                                <div class="col-lg-3 col-12 mb-2">
                                    <label for="" class="form-label">Email ID:</label>
                                    <input class="form-control" type="text" name="contactemail" value="{{ $customer->personal->contactemail }}"
                                ...
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <select id="contactrelation" name="contactrelation"
                                        class="form-select select2-distinct" data-table="profile_personal" data-value="{{ $customer->personal->contactrelation }}"
                                ...
                                <div class="col-lg-3 col-12 mb-2">
                                    ...
                                    <select id="contactzone" name="contactzone"
                                        ...
                                        <option value="{{ $item->zone_code }}" {{  $customer->personal->contactzone == $item->zone_code ?'selected':''  }}>{{ $item->zone_name }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
