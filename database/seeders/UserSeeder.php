...
class UserSeeder extends Seeder
{
	...
	public function run(): void
	{
		...
		DB::statement("insert into jodi_laravel.users (username, name, email, mobile, status, is_blocked, password)  Select li.username, li.loginname, li.email, li.mobile, li.status, li.loginstatus, :password from jodi_new.logininfo as li", ['password' => $password]);
		...
		DB::statement(
			...
			JOIN jodi_new.logininfo AS o ON  o.username = u.username 
			SET
